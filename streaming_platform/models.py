...
class Movie(models.Model):
    ...
    genre1 = models.CharField(max_length=100, choices=MOVIE_GENERES, default=None, verbose_name='Main genre')
    genre2 = models.CharField(max_length=100, choices=MOVIE_GENERES, default=None, verbose_name='Sub-genre 1')
    genre3 = models.CharField(max_length=100, choices=MOVIE_GENERES, default=None, verbose_name='Sub-genre 2')
